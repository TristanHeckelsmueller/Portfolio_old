...
var _noframeworkWaypoints = __webpack_require__(6);
...
var Trigger = function Trigger() {
  ...
  // About Me Text
  (0, _jquery2.default)("#about-me").click(function () {

    (0, _jquery2.default)(".dashboard__front__about-me").toggleClass("show-text");
  });
  // Modal
  (0, _jquery2.default)("#contact").click(function () {

    (0, _jquery2.default)(".modal").addClass("show-modal");
  });
  // Hamburger
  (0, _jquery2.default)(".modal-hamburger").click(function () {
  ...
  (0, _jquery2.default)(".dashboard__projects").click(function () {
    ...
    (0, _jquery2.default)(".dashboard__projects--background").toggleClass("show-projects--background");
    (0, _jquery2.default)(".dashboard__projects--background").toggleClass("no-blur");
    (0, _jquery2.default)(".dashboard__featured").toggleClass("no-overflow");
  });
};
...
var content_event = '<div class="cv__content__event"';

var birth_text = '<h2>Born on 23rd September</h2><p>After a long journey I finished my school career with the bayrischen Abitur. 3.1 is not a very good finish, but it counts as the hardest Abitur in Germany.</p>';
var birth_id = ' id="birth"';
var birth = content_event + birth_id + '>' + birth_text + '</div>';

var school_start_id = 'id="school-start"';
